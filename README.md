...
1. 安装 [2.1.0 正式 Release](https://github.com/ceigt/GeoLocation/releases/tag/20100-2.1.0) 附件中的正式签名 APK，Android 11 或更高版本。首次从 1.2.x Debug 切换，先保存收藏、坐标和地图凭据，再卸载旧版安装；签名不同，不能直接覆盖。
