package io.github.ceigt.geomimic.manager.mock
...
class MockLocationService : Service() {
    ...
    override fun onCreate() {
        super.onCreate()
        handlerThread = HandlerThread("GeoMimicMockProvider").also { it.start() }
    ...
    companion object {
        ...
        private const val ACTION_START = "io.github.ceigt.geomimic.action.MOCK_PROVIDER_START"
        private const val ACTION_STOP = "io.github.ceigt.geomimic.action.MOCK_PROVIDER_STOP"
        private const val CHANNEL_ID = "geomimic_mock_provider"
