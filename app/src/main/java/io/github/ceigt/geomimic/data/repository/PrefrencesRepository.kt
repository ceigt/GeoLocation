...
package io.github.ceigt.geomimic.data.repository

import android.content.Context
import android.content.SharedPreferences
import android.util.Log
import androidx.core.content.edit
import io.github.ceigt.geomimic.data.*
...
import io.github.ceigt.geomimic.manager.mock.MockLocationService
...
class PreferencesRepository(context: Context) {
    ...
    // region Per-app coordinate systems (remote)
    fun getAppCoordinateSystemsFlow(): Flow<Map<String, CoordinateSystem>> =
        remoteFlow(KEY_APP_COORDINATE_SYSTEMS, emptyMap()) {
    ...
    fun getAppCoordinateSystems(): Map<String, CoordinateSystem> =
        parseAppCoordinateSystems(remotePrefs()?.getString(KEY_APP_COORDINATE_SYSTEMS, null))
