// PreferencesUtil.kt
package io.github.ceigt.geomimic.xposed.utils

import android.content.SharedPreferences
import android.os.SystemClock
import android.util.Log
import io.github.ceigt.geomimic.data.JsonCodec
import io.github.ceigt.geomimic.data.CoordinateSystem
import io.github.ceigt.geomimic.data.DEFAULT_ACCURACY
import io.github.ceigt.geomimic.data.DEFAULT_ALTITUDE
import io.github.ceigt.geomimic.data.DEFAULT_ENABLE_SYSTEM_HOOKS
import io.github.ceigt.geomimic.data.DEFAULT_ENABLE_MOCK_PROVIDER
import io.github.ceigt.geomimic.data.DEFAULT_HIDE_FAKE_LOCATION_TOAST
import io.github.ceigt.geomimic.data.DEFAULT_MEAN_SEA_LEVEL
import io.github.ceigt.geomimic.data.DEFAULT_MEAN_SEA_LEVEL_ACCURACY
import io.github.ceigt.geomimic.data.DEFAULT_RANDOMIZE_RADIUS
import io.github.ceigt.geomimic.data.DEFAULT_SPEED
import io.github.ceigt.geomimic.data.DEFAULT_SPEED_ACCURACY
import io.github.ceigt.geomimic.data.DEFAULT_USE_ACCURACY
import io.github.ceigt.geomimic.data.DEFAULT_USE_ALTITUDE
import io.github.ceigt.geomimic.data.DEFAULT_USE_MEAN_SEA_LEVEL
import io.github.ceigt.geomimic.data.DEFAULT_USE_MEAN_SEA_LEVEL_ACCURACY
import io.github.ceigt.geomimic.data.DEFAULT_USE_RANDOMIZE
import io.github.ceigt.geomimic.data.DEFAULT_USE_SPEED
import io.github.ceigt.geomimic.data.DEFAULT_USE_SPEED_ACCURACY
import io.github.ceigt.geomimic.data.DEFAULT_USE_VERTICAL_ACCURACY
import io.github.ceigt.geomimic.data.DEFAULT_VERTICAL_ACCURACY
import io.github.ceigt.geomimic.data.KEY_ACCURACY
import io.github.ceigt.geomimic.data.KEY_APP_COORDINATE_SYSTEMS
import io.github.ceigt.geomimic.data.KEY_ALTITUDE
import io.github.ceigt.geomimic.data.KEY_ENABLE_SYSTEM_HOOKS
import io.github.ceigt.geomimic.data.KEY_ENABLE_MOCK_PROVIDER
import io.github.ceigt.geomimic.data.KEY_HIDE_FAKE_LOCATION_TOAST
import io.github.ceigt.geomimic.data.KEY_IS_PLAYING
import io.github.ceigt.geomimic.data.KEY_LAST_CLICKED_LOCATION
import io.github.ceigt.geomimic.data.KEY_MEAN_SEA_LEVEL
import io.github.ceigt.geomimic.data.KEY_MEAN_SEA_LEVEL_ACCURACY
import io.github.ceigt.geomimic.data.KEY_RANDOMIZE_RADIUS
import io.github.ceigt.geomimic.data.KEY_SPEED
import io.github.ceigt.geomimic.data.KEY_SPEED_ACCURACY
import io.github.ceigt.geomimic.data.KEY_TARGET_APPS
import io.github.ceigt.geomimic.data.KEY_USE_ACCURACY
import io.github.ceigt.geomimic.data.KEY_USE_ALTITUDE
import io.github.ceigt.geomimic.data.KEY_USE_MEAN_SEA_LEVEL
import io.github.ceigt.geomimic.data.KEY_USE_MEAN_SEA_LEVEL_ACCURACY
import io.github.ceigt.geomimic.data.KEY_USE_RANDOMIZE
import io.github.ceigt.geomimic.data.KEY_USE_SPEED
import io.github.ceigt.geomimic.data.KEY_USE_SPEED_ACCURACY
import io.github.ceigt.geomimic.data.KEY_USE_VERTICAL_ACCURACY
import io.github.ceigt.geomimic.data.KEY_VERTICAL_ACCURACY
