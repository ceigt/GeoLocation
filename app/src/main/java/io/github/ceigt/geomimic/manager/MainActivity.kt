...
import io.github.ceigt.geomimic.manager.ui.navigation.AppNavGraph
import io.github.ceigt.geomimic.manager.ui.theme.GeoMimicTheme
...
class MainActivity : ComponentActivity() {
    ...
    private fun showUnsupportedAndroidDialog() {
        AlertDialog.Builder(this)
            ...
            .setMessage("GeoMimic需要 Android 11 或更高版本。")
